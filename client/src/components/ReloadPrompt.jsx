...
// the tab being hidden/backgrounded, or a route navigation — so the user
// never loses in-progress form/chat state to a surprise mid-view reload.
// If neither happens, the browser still activates the new SW once all tabs
// close, so nobody is ever stuck on an old version.
