      ...
      <div className="auth-left">
        ...
        <div className="auth-left-body">
          ...
          <div className="auth-left-pills">
            <div className="auth-left-pill"><span className="auth-left-pill-icon"><Dna size={14} strokeWidth={2} /></span> Personalised dosha profiling</div>
            <div className="auth-left-pill"><span className="auth-left-pill-icon"><Leaf size={14} strokeWidth={2} /></span> 6 wellness pillars in one place</div>
            <div className="auth-left-pill"><span className="auth-left-pill-icon"><MessageCircle size={14} strokeWidth={2} /></span> 24/7 AI wellness advisor</div>
          </div>
        </div>
      </div>
        ...
        >
          ...
          {(GOOGLE_ENABLED || GITHUB_ENABLED) && (
            <div className="auth-social-row">
              ...
              {GITHUB_ENABLED && (
                <a href={githubOAuthURL()} className="auth-social-btn" aria-label="Sign up with GitHub">
          ...
          <form className="auth-form" onSubmit={handleEmailSubmit}>
              <div className="auth-input-group">
                ...
                <input id="name" className="auth-input" type="text" value={name} onChange={e => setName(e.target.value)} placeholder="Jane Doe" required aria-required="true" aria-invalid={!!error} />
              </div>
              <div className="auth-input-group">
